---
title: "Meta information for the dataset"
...
## Information
The present dataset is based on day-level aggregates of radial profiles of *sap flux per section* (SFS) measured with the heat field deformation (HFD) method on 38 trees belonging to 8 species of Costa Rican tropical dry forest species measured in four campaigns of 5--7 days in October and November 2015 in the Estación Experimental Forestal Horizontes, Guanacaste, Costa Rica. 

Detailed information about the sap flow meausrements measurement can be found in the main text of the accompanying publication.

| Variable | Unit | Example | Explanation |
|----------|------|---------|-------------|
|species   | -    | *Tabebuia impetiginosa* | Tree species|
|tree      | -    | H_BS2_01_03 | Tree ID (Site_Plot_Subplot_StemNo)|
